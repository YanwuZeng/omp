...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["pi", "provider", "model", "mode", "collab", "path", "git", "pr", "context_pct", "cost"],
	...
	full: {
		leftSegments: ["pi", "hostname", "provider", "model", "mode", "path", "git", "pr", "subagents"],
		rightSegments: [
			"session_name",
			"cache_hit",
			"token_in",
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "provider", "model", "mode", "path", "git", "pr", "session", "subagents"],
		rightSegments: [
			"session_name",
			"token_in",
			"token_out",
